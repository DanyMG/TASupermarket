 ...
 * @author DanyMG
 */
public class FormLaporanBarang extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLaporanBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
